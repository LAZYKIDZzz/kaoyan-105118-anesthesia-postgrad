...
ENROLL25 = {
    ...
    "山西医科大学": (31, 351), "佳木斯大学": (6, 351), "温州医科大学": (47, 351),
...
MANUAL_TIER = {
    ...
    "牡丹江医科大学": 4, "东南大学": 3, "南京大学": 3, "大连理工大学": 4,
}
...
NOTES = [
    ...
    ("国家线口径", "临床医学（专硕）A 区总分线：2024 年 304 分、2025 年 293 分、2026 年 294 分；B 区分别为 294 / 283 / 284 分左右。"),
